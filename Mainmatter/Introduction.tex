...
\end{equation}
where $\Gamma^A$ are the flat gamma matrices. Therefore the covariant derivative  and the connection can be written as
\begin{subequations}
	\begin{gather}
